...
use bevy::math::{UVec2};
use rand::{Rng, distributions::Uniform, prelude::{Distribution, StdRng, ThreadRng}};
...
fn generate_rooms(map: &mut Map, settings: &MapGenSettings, rng: &mut StdRng,  rooms: &mut Vec<Rect>) {
